...
<body>
	<div class="w3-content mxw650 w3-margin-top">
		...
		<form method="POST" action="/whistle/guestBoard/gBoardWriteProc.blp" name="frm" id="frm" class="w3-col w3-round-large w3-card-4 w3-margin-bottom w3-padding mgb20">
			<input type="hidden" name="mno" value="${FATA.mno}">
