...
<c:if test="${CNT != 1}">
		<div class="w3-content mxw650 w3-margin-top" id="div1" style="display: none;">
			...
			<form method="POST" action="/whistle/guestBoard/gBoardWriteJsonProc.blp" name="frm1" id="frm1" class="w3-col w3-round-large w3-card-4 w3-margin-bottom w3-padding mgb20">
...
<c:forEach var="data" items="${LIST}">
		<div class="w3-col w3-round-large w3-card-4 w3-margin-bottom w3-padding">
			<div class="w3-col box120 pdAll10 w3-border-right">
				<img src="/whistle/resources/img/avatar/${data.avatar}" class="inblock avtBox100 w3-border w3-border-gray">
			</div>
			<div class="w3-rest w3-padding">
